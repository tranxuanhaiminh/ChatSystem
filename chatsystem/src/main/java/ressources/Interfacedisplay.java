...
public class Interfacedisplay {
	...
	public static String connectbutton = "Connect";

	public static String mainmenutitle = "Chat System";

	public static String modifybutton = "Modify";

	public static String tablestatuscol = "Status";
